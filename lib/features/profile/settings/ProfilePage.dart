            ...
            return  Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(S.of(context).menu, style: AppFonts.style20medium,),
                  ),
                  Container(
                   margin: const EdgeInsets.symmetric( horizontal:  AppDefaults.padding),
                    ...
                    child: Row(
                      ...
                      children: [
                        AppCubit.get(context).getInfo!.avatar?.data == null ?  Padding(
                          ...
                          child: Container(
                            ...
                            child : NetworkImageWithLoader(AppCubit.get(context).getInfo!.avatar!.data!.full_url.toString()),
                          ),
                        ),
                        ...
                        Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('${AppCubit.get(context).getInfo!.first_name.toString()} ${AppCubit.get(context).getInfo!.last_name.toString()}',style: AppFonts.style16Normal,),
                            Text(role == "1" ? 'مدير' : 'موظف',style: AppFonts.style12light,),
                          ],
                        ),
                        // const  Spacer(),
                        // Padding(
                  ...
                  //  margin: const EdgeInsets.all(AppDefaults.padding ),
                    ...
                    child: Column(
                      ...
                      role == '1' ?  InkWell(
                          onTap : ()
                          {
                            Navigator.push(context, MaterialPageRoute(builder: (context) =>  const AllEmployeeScreen(admin: true),));
                          },
                          child: AppSettingsListTile(
                            style: AppFonts.style16semiBold,
                            widget: SvgPicture.asset(AppIcons.users, color:
              ...
              AppColors.textWhite :  AppColors.textBlack,
                        ...
                        AppSettingsListTile(
                            style: AppFonts.style16semiBold,
                            widget: SvgPicture.asset(AppIcons.taskDone , color: AppCubit.get(context).isDarkMode ? AppColors.textWhite :  AppColors.textBlack,),
                            label: 'المهام',
                            onTap: ()
                            {
                              Navigator.push(context, MaterialPageRoute(builder: (context) => const  TasksScreenForEmployee(back: true),));
                            }
                        ...
                        AppSettingsListTile(
                            style: AppFonts.style16semiBold,
                            widget: SvgPicture.asset(AppIcons.bell,color: AppCubit.get(context).isDarkMode ? AppColors.textWhite :  AppColors.textBlack,),
                            label: 'الاشعارات',
                            onTap: ()
                            {
                        ...
                        AppSettingsListTile(
                            style: AppFonts.style16semiBold,
                            widget: SvgPicture.asset(AppIcons.setting,
                              color:AppCubit.get(context).isDarkMode ? AppColors.textWhite :  AppColors.textBlack,
                            ),
                            label: 'الاعدادات',
                            onTap: ()
                            {
Navigator.push(context, MaterialPageRoute(builder: (context) => MainSettingsPage(),));
                        ...
                        AppSettingsListTile(
                            style: AppFonts.style16semiBold,
                            widget:
                            Icon(AppIcons.help,color: AppCubit.get(context).isDarkMode ? AppColors.textWhite :  AppColors.textBlack,),
                            label: 'المساعدة',
                            onTap: ()
                            {
                              notWork(context);
                            ...
                            return Row(
                              children: [
                                ...
                                Icon(
                                  ...
                                  color:
                                 globalDark ? AppColors.textWhite :
                                 AppColors.textBlack,),
SizedBox(width: 10.w,),
                                  Text(
                                    'الوضع الليلي',
                        ...
                        AppSettingsListTile(
                            ...
                            onTap: () async
                            {
                              await CacheHelper.clearAll().then((value) {
                                value = true;
                                if (value) {
                                  navigateFinish(context, AppRoutes.login);
                                }
                              });
                            }
