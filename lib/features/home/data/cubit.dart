...
class EmployeeCubit extends Cubit<EmployeeStates> {
 ...
 addEmployeeFun({
  ...
  }) async
  {
    ...
    await repo.addEmployee(AddEmployeeRequestModel(
      user: employeeId,
      status: status,
      email:email ,
      address: address,
  ...
  }) async
  {
    ...
    await repo.editEmployee(employeeId,AddEmployeeRequestModel(
      user: user,
      status: status,
      email:email ,
      address: address,
